namespace SsitEngine.PureMVC.Interfaces
{
    ...
    public interface IView
    {
        ...
        /// </summary>
        /// <param name="msgId">the name of the <c>INotifications</c> to notify this <c>IObserver</c> of</param>
        /// <param name="observer">the <c>IObserver</c> to register</param>
        void RegisterObserver( ushort msgId, IObserver observer );

        /// <summary>
        ///     Remove a group of observers from the observer list for a given Notification name.
        /// </summary>
        /// <param name="msgId">which observer list to remove from </param>
        /// <param name="notifyContext">removed the observers with this object as their notifyContext</param>
        void RemoveObserver( ushort msgId, object notifyContext );
