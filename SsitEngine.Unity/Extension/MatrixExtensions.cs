...
namespace SsitEngine.Unity
{
    ...
    {
        /// <summary>
        ///     获取矩阵空间旋转 <see cref="UnityEngine.Matrix4x4" />.
        /// </summary>
        ...
        /// <summary>
        ///     获取矩阵三维坐标 <see cref="UnityEngine.Matrix4x4" />.
        /// </summary>
        /// <param name="matrix"><see cref="UnityEngine.Matrix4x4" /> to extract from.</param>
        ...
        /// <summary>
        ///     获取矩阵缩放 <see cref="UnityEngine.Matrix4x4" />.
        /// </summary>
        /// <param name="matrix"><see cref="UnityEngine.Matrix4x4" /> to extract from.</param>
        ...
        {
            return new Vector3(matrix.GetColumn(0).magnitude, matrix.GetColumn(1).magnitude,
