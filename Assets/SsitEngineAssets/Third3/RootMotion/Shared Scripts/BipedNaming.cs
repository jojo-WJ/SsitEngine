...
namespace RootMotion
{
    ...
    public static class BipedNaming
    {
        ...
        public static string[]
            ...
            typeSpine =
            {
                "Spine", "spine", "Pelvis", "pelvis", "Root", "root", "Torso", "torso", "Body", "body", "Hips", "hips",
            ...
            typeLeg =
            {
                "Leg", "leg", "Thigh", "thigh", "Calf", "calf", "Femur", "femur", "Knee", "knee", "Foot", "foot",
                "Ankle", "ankle", "Hip", "hip"
            },
            typeTail = {"Tail", "tail"},
            typeEye = {"Eye", "eye"},
            ...
            typeExcludeArm =
            {
                "Collar", "collar", "Clavicle", "clavicle", "Finger", "finger", "Index", "index", "Mid", "mid", "Pinky",
                "pinky", "Ring", "Thumb", "thumb", "Adjust", "adjust", "Twist", "twist"
            },
        ...
        private static bool matchesNaming( string boneName, string[] namingConvention )
        {
            ...
            foreach (var n in namingConvention)
        ...
        {
            var lastLetter = boneName.Substring(boneName.Length - 1, 1);
        ...
        {
            var b = GetBonesOfTypeAndSide(boneType, boneSide, bones);
        ...
        {
            var bones = GetBonesOfTypeAndSide(boneType, boneSide, transforms);
