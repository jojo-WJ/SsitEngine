...
namespace RootMotion.FinalIK
{
    ...
    public class GenericPoser : Poser
    {
        ...
        public override void AutoMapping()
        {
            ...
            var poseChildren = poseRoot.GetComponentsInChildren<Transform>();
            Transform target;
        ...
        protected override void UpdatePoser()
        {
            ...
            // Calculate weights
            var rW = localRotationWeight * weight;
            var pW = localPositionWeight * weight;

            // Lerping the localRotation and the localPosition
            for (var i = 0; i < maps.Length; i++) maps[i].Update(rW, pW);
        }


        protected override void FixPoserTransforms()
        {
            for (var i = 0; i < maps.Length; i++) maps[i].FixTransform();
        }

        private void StoreDefaultState()
        {
            for (var i = 0; i < maps.Length; i++) maps[i].StoreDefaultState();
        }
