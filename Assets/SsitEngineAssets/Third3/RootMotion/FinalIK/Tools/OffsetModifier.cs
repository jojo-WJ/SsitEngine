...
namespace RootMotion.FinalIK
{
    ...
    public abstract class OffsetModifier : MonoBehaviour
    {
        ...
        protected void ApplyLimits( OffsetLimits[] limits )
        {
            ...
            foreach (var limit in limits) limit.Apply(ik.solver.GetEffector(limit.effector), transform.rotation);
        }
        ...
        public class OffsetLimits
        {
            ...
            [Tooltip("The limits")] public float minX, maxX, minY, maxY, minZ, maxZ;
            ...
            {
                var offset = Quaternion.Inverse(rootRotation) * e.positionOffset;
            ...
            {
                var illegal = value - limit;
                var s = illegal * spring;
