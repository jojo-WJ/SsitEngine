...
namespace RootMotion.FinalIK
{
    ...
    public class BodyTilt : OffsetModifier
    {
        ...
        [Tooltip("The OffsetPose components")] public OffsetPose poseLeft, poseRight;
        ...
        protected override void OnModifyOffset()
        {
            ...
            var change = Quaternion.FromToRotation(lastForward, transform.forward);
            float deltaAngle = 0;
            ...
            var tiltF = Mathf.Abs(tiltAngle) / 1f;
