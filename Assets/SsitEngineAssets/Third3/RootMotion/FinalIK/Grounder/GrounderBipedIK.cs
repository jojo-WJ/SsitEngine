    ...
    public class GrounderBipedIK : Grounder
    {
        ...
        private void OnSolverUpdate()
        {
            ...
            if (spineBend != 0f && ik.references.spine.Length > 0)
            {
                ...
                var spineOffseTarget = GetSpineOffsetTarget() * weight;
                ...
                var leftArmRotation = ik.references.leftUpperArm.rotation;
                var rightArmRotation = ik.references.rightUpperArm.rotation;

                // Get the offset rotation for the spine
                var up = solver.up;
                var f = Quaternion.FromToRotation(up, up + spineOffset);
