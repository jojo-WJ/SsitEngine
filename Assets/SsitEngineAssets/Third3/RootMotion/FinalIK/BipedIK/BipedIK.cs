...
namespace RootMotion.FinalIK
{
    ...
    public class BipedIK : SolverManager
    {
        ...
        protected override void FixTransforms()
        {
            ...
            for (var i = 0; i < solvers.limbs.Length; i++) solvers.limbs[i].FixTransforms();
        }
        ...
        protected override void InitiateSolver()
        {
            ...
            {
                Warning.Log(message, references.root);
                return;
            }
            ...
            foreach (var limb in solvers.limbs) limb.Initiate(transform);
        ...
        protected override void UpdateSolver()
        {
            ...
            for (var i = 0; i < solvers.limbs.Length; i++)
            {
            ...
            for (var i = 0; i < solvers.limbs.Length; i++) solvers.limbs[i].Update();
        }
