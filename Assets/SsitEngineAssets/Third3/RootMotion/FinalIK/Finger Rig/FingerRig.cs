...
namespace RootMotion.FinalIK
{
    ...
    public class Finger
    {
        ...
        /// </summary>
        [Tooltip("The weight of rotating the finger tip and bending the finger to the target.")] [Range(0f, 1f)]
        ...
        public void Initiate( Transform hand, int index )
        {
            ...
            var axisWorld = Vector3.Cross(bone2.position - bone1.position, tip.position - bone1.position);
        ...
        public void Update( float masterWeight )
        {
            ...
            {
                var q = Quaternion.FromToRotation(IKRotation * tipAxis, bone1.rotation * bone1Axis);
            ...
            if (bone3 != null)
            {
                if (w * rotationWeight >= 1f)
                    ...
                    bone3.rotation = Quaternion.Lerp(bone3.rotation, IKRotation * bone3RelativeToTarget,
                        w * rotationWeight);
            }
    ...
    public class FingerRig : SolverManager
    {
        ...
        public void AutoDetect()
        {
            ...
            {
                var potentialFinger = new Transform[0];
        ...
        /// </summary>
        public void AddFinger( Transform bone1, Transform bone2, Transform bone3, Transform tip,
        ...
        public void RemoveFinger( int index )
        {
            ...
            var newFingers = new Finger[fingers.Length - 1];
            var added = 0;
        ...
        public void UpdateFingerSolvers()
        {
            ...
            foreach (var finger in fingers) finger.Update(weight);
        }

        public void FixFingerTransforms()
        {
            foreach (var finger in fingers) finger.FixTransforms();
        }
