...
namespace RootMotion.FinalIK
{
    ...
    public partial class IKSolverVR : IKSolver
    {
        ...
        public abstract class BodyPart
        {
            ...
            protected abstract void OnRead( Vector3[] positions, Quaternion[] rotations, bool hasChest, bool hasNeck,
            ...
            public void Read( Vector3[] positions, Quaternion[] rotations, bool hasChest, bool hasNeck,
                bool hasShoulders, bool hasToes, int rootIndex, int index )
            {
                this.index = index;
            ...
            {
                var delta = position - bones[0].solverPosition;
                foreach (var bone in bones) bone.solverPosition += delta;
            }

            public void MoveRotation( Quaternion rotation )
            {
                var delta = QuaTools.FromToRotation(bones[0].solverRotation, rotation);
            ...
            {
                var deltaPosition = newRootPos - rootPosition;
                rootPosition = newRootPos;
                foreach (var bone in bones) bone.solverPosition += deltaPosition;

                var deltaRotation = QuaTools.FromToRotation(rootRotation, newRootRot);
            ...
            public void RotateTo( VirtualBone bone, Quaternion rotation, float weight = 1f )
            {
                ...
                var q = QuaTools.FromToRotation(bone.solverRotation, rotation);
