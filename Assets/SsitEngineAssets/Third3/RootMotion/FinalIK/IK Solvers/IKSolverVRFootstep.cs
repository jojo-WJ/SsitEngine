...
namespace RootMotion.FinalIK
{
    public partial class IKSolverVR : IKSolver
    {
        ...
        public class Footstep
        {
            ...
            public Footstep( Quaternion rootRotation, Vector3 footPosition, Quaternion footRotation,
            ...
            public void UpdateStanding( Quaternion rootRotation, float minAngle, float speed )
            {
                ...
                var r = rootRotation * footRelativeToRoot;
                var angle = Quaternion.Angle(rotation, r);
                if (angle > minAngle)
                    rotation = Quaternion.RotateTowards(rotation, r,
                        Mathf.Min(Time.deltaTime * speed * (1f - supportLegW), angle - minAngle));
            }

            public void Update( InterpolationMode interpolation, UnityEvent onStep )
            {
                var supportLegWTarget = isSupportLeg ? 1f : 0f;
                ...
                var stepProgressSmooth = Interp.Float(stepProgress, interpolation);
