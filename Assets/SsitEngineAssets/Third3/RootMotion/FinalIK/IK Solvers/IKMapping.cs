    ...
    public class IKMapping
    {
        ...
        */
        ...
        public class BoneMap
        {
            ...
            {
                var p1 = solver.GetNode(plane1ChainIndex, plane1NodeIndex).solverPosition;
                var p2 = solver.GetNode(plane2ChainIndex, plane2NodeIndex).solverPosition;
                var p3 = solver.GetNode(plane3ChainIndex, plane3NodeIndex).solverPosition;
            ...
            {
                var t = lastAnimatedTargetRotation;
            ...
            {
                var r = GetTargetRotation(solver) * defaultLocalTargetRotation;
            ...
            {
                var r = Quaternion.FromToRotation(transform.rotation * localSwingAxis, pos1 - pos2) *
                        transform.rotation;
            ...
            public void Twist( Vector3 twistDirection, Vector3 normalDirection, float weight )
            {
                ...
                var r = Quaternion.FromToRotation(transform.rotation * localTwistAxis, twistDirection) *
                        transform.rotation;
            ...
            public void RotateToEffector( IKSolverFullBody solver, float weight )
            {
                ...
                var w = weight * solver.GetNode(chainIndex, nodeIndex).effectorRotationWeight;
                if (w <= 0f) return;
                ...
                transform.rotation = Quaternion.Lerp(transform.rotation,
                    solver.GetNode(chainIndex, nodeIndex).solverRotation, w);
            }
