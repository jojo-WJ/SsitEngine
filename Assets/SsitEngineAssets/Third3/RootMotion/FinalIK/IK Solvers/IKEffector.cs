...
namespace RootMotion.FinalIK
{
    ...
    public class IKEffector
    {
        ...
        public Transform[]
            childBones =
                new Transform[0]; // The optional list of other bones that positionOffset and position of this effector will be applied to.
        ...
        public bool IsValid( IKSolver solver, ref string message )
        {
            ...
            foreach (var b in childBones)
                ...
                {
                    message = "IK Effector is referencing to a bone '" + b.name +
                              "' that does not excist in the Node Chain.";
                    return false;
                }
        ...
        public void ResetOffset( IKSolverFullBody solver )
        {
            ...
            for (var i = 0; i < childChainIndexes.Length; i++)
        ...
        * */
        ...
        private Vector3 GetPosition( IKSolverFullBody solver, out Quaternion planeRotationOffset )
        {
            ...
            return Vector3.Lerp(animatedPosition, p + solver.GetNode(chainIndex, nodeIndex).offset,
