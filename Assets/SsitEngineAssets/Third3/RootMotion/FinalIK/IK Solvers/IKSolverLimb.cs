...
namespace RootMotion.FinalIK
{
    ...
    public class IKSolverLimb : IKSolverTrigonometric
    {
        ...
        private Quaternion defaultRootRotation,
            ...
            bone3RotationBeforeSolve,
            maintainRotation,
            bone3DefaultRotation;
        ...
        private void StoreAxisDirections( ref AxisDirection[] axisDirections )
        {
            ...
            axisDirections[1] =
                new AxisDirection(new Vector3(0.5f, 0f, -0.2f), new Vector3(-0.5f, -1f, 1f)); // behind head
            axisDirections[2] =
                new AxisDirection(new Vector3(-0.5f, -1f, -0.2f), new Vector3(0f, 0.5f, -1f)); // arm twist
            axisDirections[3] =
                new AxisDirection(new Vector3(-0.5f, -0.5f, 1f), new Vector3(-1f, -1f, -1f)); // cross heart
        }
        ...
        private Vector3 GetModifiedBendNormal()
        {
            ...
            switch (bendModifier)
            {
                ...
                case BendModifier.Parent:
                    ...
                    var parentRotation = bone1.transform.parent.rotation * Quaternion.Inverse(parentDefaultRotation);
                    return Quaternion.Slerp(Quaternion.identity,
                               parentRotation * Quaternion.Inverse(defaultRootRotation), weight) * bendNormal;

                // Bending relative to IKRotation
                case BendModifier.Target:
                    var targetRotation = IKRotation * Quaternion.Inverse(bone3DefaultRotation);
                ...
                case BendModifier.Arm:
                    ...
                    var direction = (IKPosition - bone1.transform.position).normalized;

                    // Converting direction to default world space
                    direction = Quaternion.Inverse(bone1.transform.parent.rotation *
                                                   Quaternion.Inverse(parentDefaultRotation)) * direction;
                    ...
                    var armBendNormal = bone1.transform.parent.rotation * Quaternion.Inverse(parentDefaultRotation) *
                                        sum;
                ...
                case BendModifier.Goal:
                    ...
                    var normal = Vector3.Cross(bendGoal.position - bone1.transform.position,
