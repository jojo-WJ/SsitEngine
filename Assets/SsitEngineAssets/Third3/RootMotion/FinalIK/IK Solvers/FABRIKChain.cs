...
namespace RootMotion.FinalIK
{
    ...
    public class FABRIKChain
    {
        ...
        public void Stage1( FABRIKChain[] chain )
        {
            ...
            for (var i = 0; i < children.Length; i++) chain[children[i]].Stage1(chain);
        ...
        {
            var position = ik.solver.GetIKPosition();
            ...
            var pullSum = 0f;
            for (var i = 0; i < children.Length; i++) pullSum += chain[children[i]].pull;
            ...
            for (var i = 0; i < children.Length; i++)
            {
                ...
                var toChild = chain[children[i]].ik.solver.bones[0].solverPosition - position;

                // Weight of the child
                var childWeight = chain[children[i]].pull / pullSum;
