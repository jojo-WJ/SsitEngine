...
namespace RootMotion.FinalIK
{
    ...
    public class InteractionSystem : MonoBehaviour
    {
        ...
        private readonly InteractionEffector[] interactionEffectors = new InteractionEffector[9]
        {
        ...
        protected virtual void Start()
        {
            ...
            ik.solver.OnPreUpdate += OnPreFBBIK;
            ...
            foreach (var e in interactionEffectors) e.Initiate(this);
        ...
        private void UpdateEffectors()
        {
            ...
            for (var i = 0; i < interactionEffectors.Length; i++) interactionEffectors[i].Update(transform, speed);

            // Interpolate to default pull, reach values
            for (var i = 0; i < interactionEffectors.Length; i++)
                interactionEffectors[i].ResetToDefaults(resetToDefaultsSpeed * speed);
        }
        ...
        private void OnPostFBBIK()
        {
            ...
            for (var i = 0; i < interactionEffectors.Length; i++) interactionEffectors[i].OnPostFBBIK();
        ...
        public void ResetAllCallBack()
        {
            ...
            OnInteractionPause = null;
            OnInteractionResume = null;
        ...
        public bool IsInSync()
        {
            ...
            for (var i = 0; i < interactionEffectors.Length; i++)
                if (interactionEffectors[i].isPaused)
                    for (var n = 0; n < interactionEffectors.Length; n++)
        ...
        public void PauseAll()
        {
            ...
            for (var i = 0; i < interactionEffectors.Length; i++) interactionEffectors[i].Pause();
        }
        ...
        public void ResumeAll()
        {
            ...
            for (var i = 0; i < interactionEffectors.Length; i++) interactionEffectors[i].Resume();
        }
        ...
        public void StopAll()
        {
            for (var i = 0; i < interactionEffectors.Length; i++) interactionEffectors[i].Stop();
        }
        ...
        public float GetMinActiveProgress()
        {
            ...
            for (var i = 0; i < interactionEffectors.Length; i++)
                ...
                {
                    var p = interactionEffectors[i].progress;
                    if (p > 0f && p < min) min = p;
                }
        ...
        /// </summary>
        [field: Space(10)]
        [field: Tooltip("Reference to the FBBIK component.")]
