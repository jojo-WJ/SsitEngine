...
namespace RootMotion.FinalIK
{
    ...
    public class InteractionEffector
    {
        ...
        private float timer,
            ...
            weight,
            fadeInSpeed,
            defaultPositionWeight,
            defaultRotationWeight,
            defaultPull,
            defaultReach,
            defaultPush,
            defaultPushParent,
        ...
        private readonly List<bool> triggered = new List<bool>();
        ...
        public FullBodyBipedEffector effectorType { get; }
        ...
        public bool Start( InteractionObject interactionObject, string tag, float fadeInTime, bool interrupt )
        {
            ...
            for (var i = 0; i < interactionObject.events.Length; i++) triggered.Add(false);
        ...
        public void Update( Transform root, float speed )
        {
            ...
            var targetPosition = pickedUp ? pickUpPosition : target.position;
            var targetRotation = pickedUp ? pickUpRotation : target.rotation;
            ...
            if (pause) Pause();
            // Hand poser weight
            var poserWeight = interactionObject.GetValue(InteractionObject.WeightCurve.Type.PoserWeight,
                interactionTarget, timer);
        ...
        private void TriggerUntriggeredEvents( bool checkTime, out bool pickUp, out bool pause )
        {
            ...
            for (var i = 0; i < triggered.Count; i++) // If this event has not been triggered by this effector
                if (!triggered[i]) // If time has passed...
        ...
        private void PickUp( Transform root )
        {
            ...
            pickUpOnPostFBBIK = interactionObject.NeedIkPick;
        ...
        public void OnPostFBBIK()
        {
            ...
            var rotateBoneWeight =
                interactionObject.GetValue(InteractionObject.WeightCurve.Type.RotateBoneWeight, interactionTarget,
                    timer) * weight;

            if (rotateBoneWeight > 0f)
            {
                var r = pickedUp ? pickUpRotation : effector.rotation;

                var targetRotation = Quaternion.Slerp(effector.bone.rotation, r, rotateBoneWeight * rotateBoneWeight);
            ...
            {
                var bonePosition = effector.bone.position;
