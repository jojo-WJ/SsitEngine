...
namespace Mirror
{
     ...
     * hack:by jojo
     * 1、将网络管理器集成进系统底层代码库
     * 2、屏蔽 Shutdown\OnApplicationQuit Members Method ==> Imoudle.Shutdown
     */
    /// <summary>
    ...
    public class NetworkManager : SsitMonoBase, IModule
    {
        /// <summary>
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public virtual int Priority
        {
            get
            {
                return (int)EnModuleType.ENMODULECUSTOM2;
            }
        }
        ...
        {
            get { return typeof(NetworkManager).FullName; }
        }
