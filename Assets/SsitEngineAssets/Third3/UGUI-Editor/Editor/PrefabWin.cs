...
namespace U3DExtends
{
    public class PrefabWin : EditorWindow
    {
        ...
        {
            PrefabWin prefabWin = EditorWindow.GetWindow<PrefabWin>(false, "Prefab Win", true);
        ...
        public void Reset()
        {
            ...
            if (mTab == 0 && Configure.PrefabWinFirstSearchPath != "")
            {
                ...
                foreach (string s in allAssets)
                {
                    ...
                    bool isComeFromPrefab =
                        Regex.IsMatch(s, Configure.PrefabWinFirstSearchPath + @"/((?!/).)*\.prefab");
                    if (isComeFromPrefab)
                        filtered.Add(s);
                }
        ...
        string saveKey
        {
            get { return "PrefabWin " + Application.dataPath + " " + mTab; }
        }
