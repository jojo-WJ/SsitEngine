...
namespace U3DExtends
{
    public class SceneEditor
    {
        ...
        static bool HandleDragAsset( SceneView sceneView, Object handleObj )
        {
            ...
            {
                GameObject new_obj = Object.Instantiate(handleObj) as GameObject;

                if (PrefabUtility.IsPartOfPrefabInstance(new_obj))
                {
                    PrefabUtility.UnpackPrefabInstance(new_obj, PrefabUnpackMode.Completely, InteractionMode.AutomatedAction);
                }
        ...
        private static Transform NewLayoutAndEventSys( Vector3 pos )
        {
            ...
            if (layoutCanvas)
            {
                layoutCanvas.renderMode = RenderMode.ScreenSpaceOverlay;
            }
