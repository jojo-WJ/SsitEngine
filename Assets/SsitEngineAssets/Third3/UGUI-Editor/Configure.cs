...
namespace U3DExtends
{
    ...
    public static class Configure
    {
        ...
        public const string FolderName = "SsitEngineAssets/Third3/UGUI-Editor";
        ...
        private static string projectUUID = string.Empty;
        ...
        public static string ProjectUUID
        {
            ...
            {
#if UNITY_EDITOR
                if (projectUUID == string.Empty) projectUUID = UIEditorHelper.GenMD5String(Application.dataPath);
#endif
                return projectUUID;
            }
        }
