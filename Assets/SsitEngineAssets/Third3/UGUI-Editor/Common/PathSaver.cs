...
namespace U3DExtends
{
    ...
    {
        private static volatile PathSaver _instance;
        ...
        {
            return EditorPrefs.GetString("PathSaver_" + Configure.ProjectUUID + "_" + type, GeDefaultPath(type));
        }
        ...
        public void SetLastPath( PathType type, string path )
        {
            ...
            EditorPrefs.SetString("PathSaver_" + Configure.ProjectUUID + "_" + type, path);
        }
    }
}
#endif