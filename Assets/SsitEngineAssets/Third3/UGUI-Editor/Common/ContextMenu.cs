...
namespace U3DExtends
{
    ...
    {
        private static readonly List<string> mEntries = new List<string>();
        ...
        public static void AddItemWithArge( string item, bool isChecked, GenericMenu.MenuFunction2 callback,
            object arge )
        {
            if (callback != null)
            {
        ...
        //增加几种对齐菜单
        public static void AddAlignMenu()
        {
        ...
        //增加层次菜单
        public static void AddPriorityMenu()
        {
        ...
        //增加UI组件菜单
        public static void AddUIComponentMenu()
        {
        ...
        //增加显示隐藏菜单
        public static void AddShowOrHideMenu()
        {
            var hasHideWidget = false;
        ...
        public static void AddCommonItems( GameObject[] targets )
        {
            ...
            if (targets != null && targets.Length > 0)
            {
                ...
                if (targets.Length == 1)
                {
                    ...
                    var uiBase = targets[0].GetComponent<Decorate>();
                    if (uiBase != null)
                    {
