...
public class vHUDController : MonoBehaviour
{
    ...
    [Header("Health/Stamina")] public Slider healthSlider;

    public Slider staminaSlider;

    [Header("DamageHUD")] public Image damageImage;
    ...
    [Header("Controls Display")] [HideInInspector]
    ...
    [Header("Debug Window")] public GameObject debugPanel;
    ...
    [Header("Text with FadeIn/Out")] public Text fadeText;
