...
namespace Invector
{
    ...
    public class vCullingFadeControlEditor : Editor
    {
        ...
        vCullingFadeControl _fadeControl
        {
            get { return (vCullingFadeControl) target; }
        }
        ...
        void OnSceneGUI()
        {
            ...
            Handles.color = (_fadeControl.distanceToEndFade < _fadeControl.distanceToStartFade)
                ? Color.green
                : Color.red;
            Handles.DrawAAPolyLine(10f,
                new Vector3[]
                    {ray.GetPoint(_fadeControl.distanceToEndFade), ray.GetPoint(_fadeControl.distanceToStartFade)});
            ...
            Handles.CubeHandleCap(0, ray.GetPoint(_fadeControl.distanceToEndFade),
                Quaternion.LookRotation(_fadeControl.cameraTransform.position -
                                        ray.GetPoint(_fadeControl.distanceToEndFade)), 0.05f, EventType.Ignore);
            Handles.CubeHandleCap(0, ray.GetPoint(_fadeControl.distanceToEndFade),
                Quaternion.LookRotation(_fadeControl.cameraTransform.position -
                                        ray.GetPoint(_fadeControl.distanceToEndFade)), 0.05f, EventType.Ignore);
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (_fadeControl.fadeMeshRenderers != null && _fadeControl.fadeMeshRenderers.Count > 0)
            {
                ...
                {
                    EditorGUILayout.ObjectField("Renderer", _fadeControl.fadeMeshRenderers[a].renderer,
                    ...
                    for (int b = 0; b < renderer.sharedMaterials.Length; b++)
                        renderer.sharedMaterials[b] =
                            (Material) EditorGUILayout.ObjectField(renderer.sharedMaterials[b], typeof(Material),
                                false);
                    ...
                    for (int b = 0; b < _fadeControl.fadeMeshRenderers[a].fadeMaterials.Length; b++)
                        _fadeControl.fadeMeshRenderers[a].fadeMaterials[b] =
                            (Material) EditorGUILayout.ObjectField(_fadeControl.fadeMeshRenderers[a].fadeMaterials[b],
            ...
            if (_fadeControl.fadeSkinnedMeshRenderes != null && _fadeControl.fadeSkinnedMeshRenderes.Count > 0)
            {
                ...
                {
                    EditorGUILayout.ObjectField("Renderer", _fadeControl.fadeSkinnedMeshRenderes[a].renderer,
                        typeof(Renderer), true);
                    ...
                    for (int b = 0; b < _fadeControl.fadeSkinnedMeshRenderes[a].fadeMaterials.Length; b++)
                        _fadeControl.fadeSkinnedMeshRenderes[a].fadeMaterials[b] =
                            (Material) EditorGUILayout.ObjectField(
                                _fadeControl.fadeSkinnedMeshRenderes[a].fadeMaterials[b], typeof(Material), false);
            ...
            EditorGUILayout.HelpBox(
                "Your material has to be Transparent or Fade, you will also need to change the Z-write (check documentation for more information)",
                MessageType.Info);
        ...
        public void CheckRenderers()
        {
            ...
            for (int i = 0; i < meshRenderers.Length; i++)
            {
                ...
                if (_fadeControl.fadeMeshRenderers[i].renderer == null ||
                    (_fadeControl.fadeMeshRenderers[i].renderer != null && _fadeControl.fadeMeshRenderers[i].renderer !=
                     (meshRenderers[i] as Renderer)))
                    _fadeControl.fadeMeshRenderers[i].renderer = meshRenderers[i] as Renderer;
                if (_fadeControl.fadeMeshRenderers[i].originalMaterials == null ||
                    (_fadeControl.fadeMeshRenderers[i].originalMaterials != null &&
                ...
                if (_fadeControl.fadeMeshRenderers[i].fadeMaterials == null)
                    _fadeControl.fadeMeshRenderers[i].fadeMaterials =
                        new Material[meshRenderers[i].sharedMaterials.Length];
                else if (_fadeControl.fadeMeshRenderers[i].fadeMaterials.Length !=
                         meshRenderers[i].sharedMaterials.Length)
                    Array.Resize(ref _fadeControl.fadeMeshRenderers[i].fadeMaterials,
                        meshRenderers[i].sharedMaterials.Length);
            }
            ...
            for (int i = 0; i < skinnedRenderers.Length; i++)
            {
                ...
                if (_fadeControl.fadeSkinnedMeshRenderes[i].renderer == null ||
                    (_fadeControl.fadeSkinnedMeshRenderes[i].renderer != null &&
                     _fadeControl.fadeSkinnedMeshRenderes[i].renderer != (skinnedRenderers[i] as Renderer)))
                    _fadeControl.fadeSkinnedMeshRenderes[i].renderer = skinnedRenderers[i] as Renderer;
                if (_fadeControl.fadeSkinnedMeshRenderes[i].originalMaterials == null ||
                    (_fadeControl.fadeSkinnedMeshRenderes[i].originalMaterials != null &&
                ...
                if (_fadeControl.fadeSkinnedMeshRenderes[i].fadeMaterials == null)
                    _fadeControl.fadeSkinnedMeshRenderes[i].fadeMaterials =
                        new Material[skinnedRenderers[i].sharedMaterials.Length];
                else if (_fadeControl.fadeSkinnedMeshRenderes[i].fadeMaterials.Length !=
                         skinnedRenderers[i].sharedMaterials.Length)
                    Array.Resize(ref _fadeControl.fadeSkinnedMeshRenderes[i].fadeMaterials,
                        skinnedRenderers[i].sharedMaterials.Length);
            }
        }
