...
namespace Framework.Data
{
    ...
    /// </summary>
    [Serializable]
    public class NpcAttribute : CharacterAttribute, ISerializable
    {
        public NpcAttribute()
        {
            mEquips = null;
        ...
        public new Npc GetParent()
        {
            return m_baseObject as Npc;
        }
        ...
        public NpcAttribute( SerializationInfo info, StreamingContext context ) : base(info, context)
        {
