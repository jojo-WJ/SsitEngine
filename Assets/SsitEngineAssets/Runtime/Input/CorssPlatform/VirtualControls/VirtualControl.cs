    ...
    public abstract class VirtualControl : MonoBehaviour
    {
        ...
        protected virtual void Awake()
        {
            ...
            if (m_VirtualControlsManager == null)
                Debug.LogError(
                    "Error: Unable to find the VirtualControlsManager. This component must be a parent to the virtual input monitors.");
        }
        ...
        public virtual bool GetButton( InputBase.ButtonAction action )
        {
            return false;
        }
