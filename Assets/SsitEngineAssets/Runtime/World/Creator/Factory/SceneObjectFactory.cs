...
{
    public class SceneObjectFactory : IFactory
    {
        public EnFactoryType GetFactoryType()
        {
            return EnFactoryType.SceneObjectFactory;
        }

        public object CreateInstance( string guid )
        {
            var obj = new SceneObject(guid);
            return obj;
        }
        ...
        {
            var obj = new SceneObject(Guid.NewGuid().ToString());
            return obj;
        }
    }
}