...
namespace SsitEngine.Editor
{
    public class JojoHotKeyTool : ScriptableObject
    {
        ...
        public const string
            MENU_DISABLE_SELECTED_GAMEOBJ =
                "Tools/MyTool/Enable\\Disable Multi GameObj %#z"; //%#d 即代表 command 加shift 加 d快捷键
        ...
        [UnityEditor.MenuItem("Tools/MyTool/Apply Selected Prefabs")]
