...
{
    private readonly float mElementHeight = 20;
    ...
    {
        var refrence = serializedObject.FindProperty("m_builtInRefrence");
        ...
        mReorderableList.drawElementCallback = ( rect, index, isActive, isFocused ) =>
        {
            ...
            var rect1 = new Rect(rect.x, rect.y, rect0.width, EditorGUIUtility.singleLineHeight);
            EditorGUI.BeginChangeCheck();
            EditorGUI.PropertyField(rect1, refrence.GetArrayElementAtIndex(index),
                new GUIContent($"refrece dll_{index}"), true);
        };
        ...
        //移除元素回调
        mReorderableList.onRemoveCallback = l =>
        {
