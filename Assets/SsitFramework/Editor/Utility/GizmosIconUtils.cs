...
namespace SsitEngine.Editor.Utility
{
    ...
    public class GizmosIconUtils
    {
        ...
        private static GUIContent[] GetTextures( string baseName, string postFix, int startIndex, int count )
        {
            ...
            var mi = t.GetMethod("IconContent", BindingFlags.Public | BindingFlags.Static, null, new[] {typeof(string)},
                null);

            for (var index = 0; index < count; ++index)
            {
                guiContentArray[index] =
                    mi.Invoke(null, new object[] {baseName + (startIndex + index) + postFix}) as GUIContent;
            }
        ...
        public static void SetIcon( object gObj, Texture2D texture )
        {
            ...
            mi.Invoke(null, new[] {gObj, texture});
