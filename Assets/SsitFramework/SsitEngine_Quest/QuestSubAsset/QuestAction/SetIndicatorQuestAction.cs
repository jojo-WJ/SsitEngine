...
namespace SsitEngine.QuestManager
{
    ...
    {
        [Tooltip("ID of entity whose indicator to set, or blank to set quest giver.")] [SerializeField]
        private string m_entityID;

        [Tooltip("ID of quest for which this indicator state applies, or blank for this quest.")] [SerializeField]
        private string m_questID;

        [Tooltip("Quest indicator state to set on the entity.")] [SerializeField]
        ...
        public string runtimeEntityID
        {
            ...
            {
                var s = entityID;
                return string.IsNullOrEmpty(s) && quest != null
                    ? quest.QuestGiverId
                    : QuestMachineTags.ReplaceTags(s, quest);
            }
        }
        ...
        {
            var affectedQuest = string.IsNullOrEmpty(questID) ? quest : QuestUtility.GetQuestInstance(questID);
