...
namespace SsitEngine.QuestManager
{
    ...
    public class CounterQuestCondition : QuestCondition
    {
        ...
        { 
            ...
            {
                if (Engine.Debug)
                    SsitDebug.Warning("QuestMachine: QuestCounterCondition.OnCounterChanged(" + counter.name + " = " + counter.currentValue + "): requiredCounterValue field is null. Please contact the developer.", quest);
                return false;
            }
            if (Engine.Debug)
                SsitDebug.Debug("QuestMachine: QuestCounterCondition.OnCounterChanged(" + counter.name + " = " + counter.currentValue + ")", quest);
