...
{
    [AddComponentMenu("SsitEngine.Unity.Unity/SoundManager")]
    public partial class SoundManager
    {
        ...
        /// <summary>
        ///     Plays the clip immediately regardless of a playing SoundConnection, with an option to loop.  Calls an event once
        ///     the clip is done.
        ///     You can resume a SoundConnection afterwards if you so choose, using Instance.currentSoundConnection.  However, it
        ///     will not resume on it's own.
        ...
        /// </param>
        public static void PlayImmediately( AudioClip clip2play, bool loop = false, UnityEvent runOnEndFunction = null )
        {
            Instance._PlayImmediately(clip2play, loop, runOnEndFunction);
        }

        /// <summary>
        ///     Plays the clip by crossing out what's currently playing regardless of a playing SoundConnection, with an option to
        ///     loop.  Calls an event once the clip is done.
        ///     You can resume a SoundConnection afterwards if you so choose, using Instance.currentSoundConnection.  However, it
        ///     will not resume on it's own.
        ///     Callbacks will only fire once.
        /// </summary>
        ...
        ///     Whether the clip should loop
        /// </param>
        public static void Play( AudioClip clip2play, bool loop = false, UnityEvent runOnEndFunction = null )
        {
        ...
        /*private void OnApplicationFocus(bool focus)
	{
        ...
        /// <summary>
        ///     创建一个声音连接。可以使用场景名或自定义名称。
        /// </summary>
        public static SoundConnection CreateSoundConnection( string lvl, PlayMethod method,
        ...
        public static SoundConnection CreateSoundConnection( string lvl, PlayMethod method, float delayPlay,
            params AudioClip[] audioList )
        {
        ...
        public static SoundConnection CreateSoundConnection( string lvl, PlayMethod method,
            float minDelayPlay, float maxDelayPlay, params AudioClip[] audioList )
        {
