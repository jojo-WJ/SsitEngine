...
namespace SsitEngine.Unity.Sound
{
    ...
    public class SFXGroup
    {
        ...
        /// <summary>
        ///     The specific cap amount. If set to -1, it will use the default global cap amount. If set to 0, the group will not
        ///     use a specific cap amount at all. This amount will only be respected when using SoundManager.PlayCappedSFX
        /// </summary>
