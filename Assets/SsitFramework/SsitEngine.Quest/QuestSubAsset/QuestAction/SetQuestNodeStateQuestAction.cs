...
namespace SsitEngine.QuestManager
{
    ...
    {
        [Tooltip("ID of quest. Leave blank to set this quest's state.")] [SerializeField]
        private string m_questID;

        [Tooltip("ID of quest node. Leave blank to set this quest node's state.")] [SerializeField]
        private string m_questNodeID;

        [Tooltip("New quest node state.")] [SerializeField]
        ...
        {
            get => string.IsNullOrEmpty(m_questID) && quest != null ? quest.Id : m_questID;
            set => m_questID = value;
        }
        ...
        {
            get => string.IsNullOrEmpty(m_questNodeID) && questNode != null ? questNode.Id : m_questNodeID;
