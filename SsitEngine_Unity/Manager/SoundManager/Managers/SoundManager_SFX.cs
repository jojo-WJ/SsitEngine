...
namespace SsitEngine.Unity.Sound
{
    public partial class SoundManager
    {
        ...
        /// <summary>
        ///     Plays the SFX on an owned & pooled object, will default the location to (0,0,0), pitch to
        ///     SoundManager.Instance.pitchSFX, volume to SoundManager.Instance.volumeSFX
        /// </summary>
        public static AudioSource PlaySFX( AudioClip clip, bool looping = false, float delay = 0f,
            float volume = float.MaxValue, float pitch = float.MaxValue, Vector3 location = default,
        ...
        public static AudioSource PlaySFXUI( AudioClip clip, bool looping = false, float delay = 0f,
            float volume = float.MaxValue, float pitch = float.MaxValue, UnityEvent runOnEndFunction = null,
        ...
        /// <summary>
        ///     Plays the SFX on an owned & pooled object by clipname reference on the SoundManager, will default the location to
        ///     (0,0,0), pitch to SoundManager.Instance.pitchSFX, volume to SoundManager.Instance.volumeSFX
        /// </summary>
        public static AudioSource PlaySFX( string clipName, bool looping = false, float delay = 0f,
            float volume = float.MaxValue, float pitch = float.MaxValue, Vector3 location = default,
            UnityEvent runOnEndFunction = null, SoundDuckingSetting duckingSetting = SoundDuckingSetting.DoNotDuck,
            float duckVolume = 0f, float duckPitch = 1f )
        {
        ...
        public static AudioSource PlaySFXUI( string clipName, bool looping = false, float delay = 0f,
            float volume = float.MaxValue, float pitch = float.MaxValue, UnityEvent runOnEndFunction = null,
            SoundDuckingSetting duckingSetting = SoundDuckingSetting.DoNotDuck, float duckVolume = 0f,
            float duckPitch = 1f )
        {
        ...
        /// <summary>
        ///     Plays the SFX IFF other SFX with the same cappedID are not over the cap limit. Will default the location to
        ///     (0,0,0), pitch to SoundManager.Instance.pitchSFX, volume to SoundManager.Instance.volumeSFX
        /// </summary>
        public static AudioSource PlayCappedSFX( AudioClip clip, string cappedID, float volume = float.MaxValue,
        ...
        public static AudioSource PlayCappedSFXUI( AudioClip clip, string cappedID, float volume = float.MaxValue,
        ...
        /// <summary>
        ///     Plays the SFX IFF other SFX with the same cappedID are not over the cap limit. pitch to
        ///     SoundManager.Instance.pitchSFX, volume to SoundManager.Instance.volumeSFX
        /// </summary>
        public static AudioSource PlayCappedSFX( string clipName, string cappedID, float volume = float.MaxValue,
            float pitch = float.MaxValue, Vector3 location = default )
        {
            if (Instance.offTheSFX || Instance.isPaused)
            {
        ...
        public static AudioSource PlayCappedSFXUI( string clipName, string cappedID, float volume = float.MaxValue,
            float pitch = float.MaxValue )
        {
            if (Instance.offTheSFX || Instance.isPaused)
            {
        ...
        /// <summary>
        ///     Plays the SFX IFF other SFX with the same cappedID are not over the cap limit. Will default the pitch to
        ///     SoundManager.Instance.pitchSFX, volume to SoundManager.Instance.volumeSFX
        /// </summary>
            ...
            float volume = float.MaxValue, float pitch = float.MaxValue )
        {
            ...
            if (!Instance.IsAtCapacity(cappedID, clipName))
            {
                ...
                return Instance.PlaySFXOn(aS, Load(clipName), volume, pitch, true, cappedID);
            }
            return null;
        }

        /// <summary>
        ///     Plays the SFX another audiosource of your choice, will default the looping to false, pitch to
        ///     SoundManager.Instance.pitchSFX, volume to SoundManager.Instance.volumeSFX
        /// </summary>
        /// <param name='clip'>
        ///     Clip.
        ...
        ///     Duck pitch.
        /// </param>
        public static AudioSource PlaySFX( AudioSource aS, AudioClip clip, bool looping = false, float delay = 0f,
            float volume = float.MaxValue, float pitch = float.MaxValue, UnityEvent runOnEndFunction = null,
            SoundDuckingSetting duckingSetting = SoundDuckingSetting.DoNotDuck, float duckVolume = 0f,
            float duckPitch = 1f )
        {
            ...
            return Instance.PlaySFXOn(aS, clip, volume, pitch, false, "", looping, delay, runOnEndFunction,
                duckingSetting, duckVolume, duckPitch);
        }
        ...
        ///     SoundManager.Instance.pitchSFX, volume to SoundManager.Instance.volumeSFX
        /// </summary>
        public static AudioSource PlaySFX( AudioSource aS, string clipName, bool looping = false, float delay = 0f,
            float volume = float.MaxValue, float pitch = float.MaxValue, UnityEvent runOnEndFunction = null,
            SoundDuckingSetting duckingSetting = SoundDuckingSetting.DoNotDuck, float duckVolume = 0f,
            float duckPitch = 1f )
        {
            ...
            return Instance.PlaySFXOn(aS, Load(clipName), volume, pitch, false, "", looping, delay,
                runOnEndFunction, duckingSetting, duckVolume, duckPitch);
        }
        ...
        /// <summary>
        ///     Plays the SFX another gameObject of your choice, will default the looping to false, pitch to
        ///     SoundManager.Instance.pitchSFX, volume to SoundManager.Instance.volumeSFX
        /// </summary>
        /// <param name='gO'>
        ...
        ///     Duck pitch.
        /// </param>
        public static AudioSource PlaySFX( GameObject gO, AudioClip clip, bool looping = false, float delay = 0f,
            float volume = float.MaxValue, float pitch = float.MaxValue, UnityEvent runOnEndFunction = null,
            SoundDuckingSetting duckingSetting = SoundDuckingSetting.DoNotDuck, float duckVolume = 0f,
            float duckPitch = 1f )
        {
        ...
        ///     Duck pitch.
        /// </param>
        public static AudioSource PlaySFX( GameObject gO, string clipName, bool looping = false, float delay = 0f,
            float volume = float.MaxValue, float pitch = float.MaxValue, UnityEvent runOnEndFunction = null,
            SoundDuckingSetting duckingSetting = SoundDuckingSetting.DoNotDuck, float duckVolume = 0f,
            float duckPitch = 1f )
        {
        ...
        /// <summary>
        ///     Plays the SFX in a loop on another audiosource of your choice.  This function is cattered more towards customizing
        ///     a loop.
        ///     You can set the loop to end when the object dies or a maximum duration, whichever comes first.
        ///     tillDestroy defaults to true, pitch to SoundManager.Instance.pitchSFX, volume to SoundManager.Instance.volumeSFX,
        ///     maxDuration to 0f
        /// </summary>
        public static AudioSource PlaySFXLoop( AudioSource aS, AudioClip clip, bool tillDestroy = true,
            float volume = float.MaxValue, float pitch = float.MaxValue, float maxDuration = 0f,
            UnityEvent runOnEndFunction = null, SoundDuckingSetting duckingSetting = SoundDuckingSetting.DoNotDuck,
            float duckVolume = 0f, float duckPitch = 1f )
        {
            if (Instance.offTheSFX || Instance.isPaused)
            ...
            return Instance.PlaySFXLoopOn(aS, clip, tillDestroy, volume, pitch, maxDuration, runOnEndFunction,
                duckingSetting, duckVolume, duckPitch);
        }
        ...
        ///     maxDuration to 0f
        /// </summary>
        public static AudioSource PlaySFXLoop( AudioSource aS, string clipName, bool tillDestroy = true,
            float volume = float.MaxValue, float pitch = float.MaxValue, float maxDuration = 0f,
            UnityEvent runOnEndFunction = null, SoundDuckingSetting duckingSetting = SoundDuckingSetting.DoNotDuck,
            float duckVolume = 0f, float duckPitch = 1f )
        {
            ...
            return Instance.PlaySFXLoopOn(aS, Load(clipName), tillDestroy, volume, pitch, maxDuration,
                runOnEndFunction, duckingSetting, duckVolume, duckPitch);
        }

        /// <summary>
        ///     Plays the SFX in a loop on another gameObject of your choice.  This function is cattered more towards customizing a
        ///     loop.
        ///     You can set the loop to end when the object dies or a maximum duration, whichever comes first.
        ///     tillDestroy defaults to true, pitch to SoundManager.Instance.pitchSFX, volume to SoundManager.Instance.volumeSFX,
        ///     maxDuration to 0f
        /// </summary>
        public static AudioSource PlaySFXLoop( GameObject gO, AudioClip clip, bool tillDestroy = true,
            float volume = float.MaxValue, float pitch = float.MaxValue, float maxDuration = 0f,
            UnityEvent runOnEndFunction = null, SoundDuckingSetting duckingSetting = SoundDuckingSetting.DoNotDuck,
            float duckVolume = 0f, float duckPitch = 1f )
        {
            ...
            return Instance.PlaySFXLoopOn(gO.GetComponent<AudioSource>(), clip, tillDestroy, volume, pitch, maxDuration,
                runOnEndFunction, duckingSetting, duckVolume, duckPitch);
        }
        ...
        ///     maxDuration to 0f
        /// </summary>
        public static AudioSource PlaySFXLoop( GameObject gO, string clipName, bool tillDestroy = true,
            float volume = float.MaxValue, float pitch = float.MaxValue, float maxDuration = 0f,
            UnityEvent runOnEndFunction = null, SoundDuckingSetting duckingSetting = SoundDuckingSetting.DoNotDuck,
            float duckVolume = 0f, float duckPitch = 1f )
        {
            ...
            return Instance.PlaySFXLoopOn(gO.GetComponent<AudioSource>(), Load(clipName), tillDestroy,
                volume, pitch, maxDuration, runOnEndFunction, duckingSetting, duckVolume, duckPitch);
        }
	...
	*/
        ...
        /// <summary>
        ///     Saves the SFX to the SoundManager prefab for easy access for frequently used SFX.  Will register the SFX to the
        ///     group.
        /// </summary>
        /// <param name='clip'>
        ///     Clip.
        ...
        public static void SaveSFX( AudioClip clip, SFXGroup grp )
        {
            ...
            if (grp != null)
            {
                ...
                {
                    Debug.LogWarning("The SFXGroup, " + grp.groupName +
                                     ", already exists. This new group will not be added.");
                }
            }
        ...
        public static void DeleteSFX( params string[] clipNames )
        {
            foreach (var clipName in clipNames)
            {
                ...
                {
                    var clip = Instance.allClips[clipName];
                    Instance.allClips.Remove(clipName);
                    Instance.prepools.Remove(clipName);
                    Instance.baseVolumes.Remove(clipName);
                    Instance.volumeVariations.Remove(clipName);
        ...
        /// <summary>
        ///     Applies the attributes available in the editor to SFX. Attributes like prepool amount, base volume, volume
        ///     variation, and pitch variation.
        /// </summary>
        /// <param name='clip'>
        ///     Clip.
        /// </param>
        ...
        ///     Pitch variation.
        /// </param>
        public static void ApplySFXAttributes( AudioClip clip, int prepool, float baseVolume, float volumeVariation,
            float pitchVariation )
        {
            ...
            var oldPrepool = Instance.prepools[clipName];
        ...
        /// <summary>
        ///     Applies the attributes available in the editor to SFX, referenced by clip name. Attributes like prepool amount,
        ///     base volume, volume variation, and pitch variation.
        /// </summary>
        /// <param name='clipName'>
        ///     Clip name.
        /// </param>
        ...
        ///     Pitch variation.
        /// </param>
        public static void ApplySFXAttributes( string clipName, int prepool, float baseVolume, float volumeVariation,
            float pitchVariation )
        {
        ...
        public static SFXGroup CreateSFXGroup( string grpName, int capAmount )
        {
            ...
            {
                var grp = new SFXGroup(grpName, capAmount);
        ...
        ///     SFX object.
        /// </param>
        public static void ResetSFXObject( GameObject sfxObj, bool isUI = false )
        {
        ...
        ///     Run on end function.
        /// </param>
        public static void Crossfade( float duration, AudioSource fromSource, AudioSource toSource,
            UnityEvent runOnEndFunction = null )
        {
        ...
        ///     Run on end function.
        /// </param>
        public static void Crossfade( float duration, GameObject fromSFXObject, GameObject toSFXObject,
            UnityEvent runOnEndFunction = null )
        {
            Crossfade(duration, fromSFXObject.GetComponent<AudioSource>(), toSFXObject.GetComponent<AudioSource>(),
                runOnEndFunction);
        }
        ...
        ///     Run on end function.
        /// </param>
        public static void CrossIn( float duration, AudioSource source, UnityEvent runOnEndFunction = null )
        {
        ...
        ///     Run on end function.
        /// </param>
        public static void CrossIn( float duration, GameObject sfxObject, UnityEvent runOnEndFunction = null )
        {
        ...
        ///     Run on end function.
        /// </param>
        public static void CrossOut( float duration, AudioSource source, UnityEvent runOnEndFunction = null )
        {
        ...
        ///     Run on end function.
        /// </param>
        public static void CrossOut( float duration, GameObject sfxObject, UnityEvent runOnEndFunction = null )
        {
