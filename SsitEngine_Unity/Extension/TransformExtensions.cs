...
namespace SsitEngine.Unity
{
    ...
    public static class TransformExtensions
    {
        ...
        /// <param name="local">
        ///     If true, copies the <see cref="UnityEngine.Matrix4x4" /> components to <see cref="UnityEngine.Transform" /> local
        ///     components.
        ///     Otherwise, copies the <see cref="UnityEngine.Matrix4x4" /> components to <see cref="UnityEngine.Transform" /> world
        ///     components.
        /// </param>
        /// <example>
        ///     @code
        ...
        ///     给子节点添加父对象
        /// </summary>
        public static void AddChildNodeToParentNode( this Transform childNode, Transform parentNode )
        {
