...
namespace SsitEngine.QuestManager
{
    ...
    public class ParentQuestCondition : QuestCondition
    {
        ...
        {
            if (Engine.Debug)
                SsitDebug.Debug("Quest Machine: ParentCountQuestCondition.ConnectToParentNodes(" + (add ? "listen for parent changes" : "stop listening for parent changes") + ")", quest);
        ...
        {
            if (Engine.Debug)
                SsitDebug.Debug("Quest Machine: ParentCountQuestCondition.OnParentStateChange(" + ((parentNode != null) ? parentNode.GetEditorName() : "null") + ")", quest);
